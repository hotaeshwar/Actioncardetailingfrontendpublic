...
// Import the quality service images from public folder
const certifiedExpertsImg = '/images/CertifiedExperts.png';
const keepingCustomersHappyImg = '/images/KeepingCustomersHappy.png';
const licensedInsuredImg = '/images/Licensedandinsured.png';
const professionalInstallationImg = '/images/ProfessionalInstallation.png';
const qualityGuaranteeImg = '/images/QualityGuarantee.png';
              ...
              <div key={feature.id} className="group h-full w-full">
                <div className="relative bg-white rounded-xl shadow-lg h-full flex flex-col p-4 md:p-10">
                  <div className="mx-auto flex items-center justify-center flex-shrink-0 mb-3 md:mb-6">
                    <div className="w-12 h-12 md:w-20 md:h-20 bg-gray-100 rounded-full" />
                  </div>
                    ...
                    <div className={`mx-auto flex items-center justify-center flex-shrink-0 ${isSmallScreen ? 'mb-3' : 'mb-4 sm:mb-5 md:mb-6'}`}>
                      <img
                        ...
                        className={`object-contain transition-all duration-300 ${
                          isSmallScreen ? 'w-12 h-12' : 'w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20'
                        }`}
                        style={{ 
                          filter: isActive 
