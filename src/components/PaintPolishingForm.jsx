...
// Remove the src import and use public path
...
const PaintPolishingPDF = ({ bookingId, selectedVehicle, selectedPackage, selectedAddOns, selectedDate, selectedTime, bookingData, getTotalPrice }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        ...
        />
        <View>
          <Text style={styles.headerText}>Paint Polishing Booking</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>{bookingData.firstName} {bookingData.lastName}</Text>
        </View>
        <View style={styles.row}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>{bookingData.vehicleMake}</Text>
        </View>
        {bookingData.message && (
          <View style={styles.row}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>{selectedVehicle.name}</Text>
        </View>
        <View style={styles.row}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>{selectedPackage.duration}</Text>
        </View>
      </View>
        ...
        <View style={styles.section}>
          ...
          {selectedAddOns.map((addon, index) => (
            <View key={index} style={styles.row}>
              <Text style={styles.value}>{addon.name}</Text>
              <Text style={styles.value}>${addon.price}.00 CAD</Text>
            </View>
          ))}
        </View>
      )}
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          <Text style={styles.label}>{selectedPackage.name}:</Text>
          <Text style={styles.value}>${selectedPackage.price}.00 CAD</Text>
        </View>
        ...
        <View style={styles.totalRow}>
          ...
          <Text style={styles.totalValue}>${getTotalPrice()}.00 CAD</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        <Text style={styles.note}>
          * This booking requires confirmation from Action Car Detailing. 
          You will receive confirmation within 24 hours.
        </Text>
        <Text style={styles.note}>
          * Please bring this PDF to your appointment.
        </Text>
      </View>

      {/* Footer */}
      <View style={styles.footer}>
        <Text>Action Car Detailing • (204) 775-0005 • actioncardetailing@gmail.com</Text>
        <Text>Generated on {new Date().toLocaleDateString()} • Booking ID: {bookingId}</Text>
      </View>
    </Page>
  </Document>
);
