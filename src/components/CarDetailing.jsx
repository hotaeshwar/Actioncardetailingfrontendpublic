...
const CarDetailing = () => {
  ...
  const cardData = [
    ...
    },
    {
      ...
      icon: faTrophy,
      customImage: '/images/insurance.png',
    ...
    },
    {
      ...
      icon: faStar,
      customImage: '/images/Awardhome.png',
      isAwardLogo: true,
                      ...
                      <div className={card.isAwardLogo ? "mb-1" : "mb-6"}>
                        {card.customImage ? (
                          <img 
                            ...
                            alt={card.frontTitle}
                            className={card.isAwardLogo ? 
                              "w-44 h-44 sm:w-48 sm:h-48 lg:w-52 lg:h-52 object-contain" : 
                      ...
                      <div className="flex items-center justify-center mb-4">
                        {card.customImage ? (
                          <img 
                            ...
                            alt={card.backTitle}
                            className={card.isAwardLogo ? 
                              "w-22 h-22 sm:w-24 sm:h-24 mr-3 object-contain" : 
                              "w-10 h-10 sm:w-12 sm:h-12 mr-3 object-contain"
                            }
                          />
                        ) : (
                          <FontAwesomeIcon 
                ...
                <div className={card.isAwardLogo ? "mb-1" : "mb-3"}>
                  {card.customImage ? (
                    <img 
                      ...
                      style={{
                        width: card.isAwardLogo ? (isMobile ? '80px' : '120px') : (isMobile ? '48px' : '64px'),
                        height: card.isAwardLogo ? (isMobile ? '80px' : '120px') : (isMobile ? '48px' : '64px')
                      }}
                    />
                  ) : (
                    <FontAwesomeIcon 
                ...
                <div className="flex items-center flex-1">
                  {selectedCard.customImage ? (
                    <img 
                      ...
                      className={selectedCard.isAwardLogo ? 
                        "w-16 h-16 sm:w-20 sm:h-20 mr-3 sm:mr-4 object-contain flex-shrink-0" : 
                        "w-10 h-10 sm:w-12 sm:h-12 mr-3 sm:mr-4 object-contain flex-shrink-0"
                      }
                    />
                  ) : (
                    <FontAwesomeIcon 
