        ...
        >
          ...
          <div className="absolute inset-0 z-0" style={{ height: '100%', width: '100%' }}>
            <video
              ...
              src="/images/Paint Correction Polishing (1).mp4"
              autoPlay
              loop
              muted
              playsInline
            ...
            <div className="order-1 lg:order-2 space-y-6">
              {[
                ...
                },
                {
                  ...
                  description: "Several stages of polishing are often required to achieve full correction.",
                  bgColor: '#1aa3d0'
                },
                {
                  step: "4",
                  title: "Sealing and Coating",
                  description: "Coat your car's paint to protect it from further scratching.",
                  bgColor: '#0c7aa4'
                }
              ].map((process, index) => (
