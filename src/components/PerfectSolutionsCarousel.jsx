...
const carwashing1 = '/images/carwashing1.mp4';
const carwashing2 = '/images/carwashing2.mp4';
const carwashing4 = '/images/carwashing4.mp4';
const carouselVideo = '/images/Ceramic coating (1).mp4';
